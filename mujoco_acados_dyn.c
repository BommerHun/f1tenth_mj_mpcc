...
static char xml_path[200] = "/home/peter/Utils/AIMotionLab-Virtual/aiml_virtual/resources/xml_models/control_scene.xml";
...
int disc_dyn_fun_jac(void **in, void **out, void *params)
{
    ...
    double qpos0[nq];
    for (int i = 0; i < nq; i++) {
        if (i == 3 || i == 12) qpos0[i] = 1.0; else qpos0[i] = 0.0;
    }
