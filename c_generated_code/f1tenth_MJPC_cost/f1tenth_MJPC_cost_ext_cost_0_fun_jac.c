...
#else
  #define CASADI_PREFIX(ID) f1tenth_MJPC_cost_ext_cost_0_fun_jac_ ## ID
#endif
...
/* f1tenth_MJPC_cost_ext_cost_0_fun_jac:(i0[26],i1[7],i2[0],i3[0])->(o0,o1[33]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i;
  casadi_real **res1=res+2, *rr, *ss;
  const casadi_real **arg1=arg+4, *cs;
  casadi_real w0, *w1=w+13, w2, w4, w5, w6, *w7=w+43, w8, *w9=w+46, *w10=w+48, w11, w12, *w13=w+52, w14, w15, w16, w17, *w18=w+63;
  /* #0: @0 = 50 */
  w0 = 50.;
  /* #1: @1 = input[0][0] */
  ...
  *rr++ = w4;
  ...
  /* #57: @18 = (-@7) */
  for (i=0, rr=w18, cs=w7; i<2; ++i) *rr++ = (- *cs++ );
  /* #58: @11 = (2.*@11) */
  w11 = (2.* w11 );
  /* #59: @0 = (@0*@11) */
  w0 *= w11;
  ...
  /* #61: @18 = (@18-@10) */
  for (i=0, rr=w18, cs=w10; i<2; ++i) (*rr++) -= (*cs++);
  /* #62: {@11, @8} = vertsplit(@18) */
  w11 = w18[0];
  w8 = w18[1];
  /* #63: (@1[1] += @8) */
...
CASADI_SYMBOL_EXPORT int f1tenth_MJPC_cost_ext_cost_0_fun_jac(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int f1tenth_MJPC_cost_ext_cost_0_fun_jac_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int f1tenth_MJPC_cost_ext_cost_0_fun_jac_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void f1tenth_MJPC_cost_ext_cost_0_fun_jac_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int f1tenth_MJPC_cost_ext_cost_0_fun_jac_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void f1tenth_MJPC_cost_ext_cost_0_fun_jac_release(int mem) {
}

CASADI_SYMBOL_EXPORT void f1tenth_MJPC_cost_ext_cost_0_fun_jac_incref(void) {
}

CASADI_SYMBOL_EXPORT void f1tenth_MJPC_cost_ext_cost_0_fun_jac_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int f1tenth_MJPC_cost_ext_cost_0_fun_jac_n_in(void) { return 4;}

CASADI_SYMBOL_EXPORT casadi_int f1tenth_MJPC_cost_ext_cost_0_fun_jac_n_out(void) { return 2;}

CASADI_SYMBOL_EXPORT casadi_real f1tenth_MJPC_cost_ext_cost_0_fun_jac_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* f1tenth_MJPC_cost_ext_cost_0_fun_jac_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* f1tenth_MJPC_cost_ext_cost_0_fun_jac_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    case 1: return "o1";
    default: return 0;
...
CASADI_SYMBOL_EXPORT const casadi_int* f1tenth_MJPC_cost_ext_cost_0_fun_jac_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* f1tenth_MJPC_cost_ext_cost_0_fun_jac_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int f1tenth_MJPC_cost_ext_cost_0_fun_jac_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 9;
  if (sz_res) *sz_res = 6;
  if (sz_iw) *sz_iw = 8;
  if (sz_w) *sz_w = 65;
...
CASADI_SYMBOL_EXPORT int f1tenth_MJPC_cost_ext_cost_0_fun_jac_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
